...
bool symSmbclient() {
	...
	smbcNewContext = reinterpret_cast<decltype(smbcNewContext)>(dlsym(lib, "smbc_new_context"));
	...
	if (!(smbcNewContext && smbcInitContext && smbcSetContext && smbcFreeContext && smbcGetFunctionOpen && smbcGetFunctionRead && smbcGetFunctionClose && smbcGetFunctionStat && smbcGetFunctionFstat && smbcGetFunctionOpendir && smbcGetFunctionReaddir && smbcGetFunctionClosedir && smbcSetFunctionAuthDataWithContext && smbcGetUser && smbcSetUser && smbcGetWorkgroup && smbcSetWorkgroup && smbcGetPort && smbcSetPort && smbcGetOptionUserData && smbcSetOptionUserData)) {
