...
extern decltype(libssh2_userauth_list)* sshUserauthList;	// may be nullptr
extern decltype(libssh2_userauth_password_ex)* sshUserauthPasswordEx;	// may be nullptr
extern decltype(libssh2_userauth_publickey_fromfile_ex)* sshUserauthPublickeyFromfileEx;	// may be nullptr
...
extern decltype(libssh2_sftp_unlink_ex)* sftpUnlinkEx;	// may be nullptr
extern decltype(libssh2_sftp_rmdir_ex)* sftpRmdirEx;	// may be nullptr
extern decltype(libssh2_sftp_rename_ex)* sftpRenameEx;	// may be nullptr
