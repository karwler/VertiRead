...
void RendererVk::createTextureDirect(const byte* pix, uint32 pitch, uint8 bpp, VkFormat format, TextureVk& tex) {
...
void RendererVk::uploadInputData(const byte* pix, u32vec2 res, uint32 pitch, uint8 bpp) {
